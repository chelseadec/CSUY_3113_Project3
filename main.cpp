...
const char SPRITESHEET_FILEPATH[] = "oreo.png";
const char PLATFORM_FILEPATH[]    = "milk.png";
...
void initialise()
{
    ...
    g_state.player->set_acceleration(glm::vec3(0.0f, -0.05f, 0.0f)); // y-position is the effect of gravity on the object
...
void process_input()
{
    ...
    {
        g_state.player->m_movement.x = 0.5f;
        g_state.player->set_acceleration(glm::vec3(1.0f, -0.05f, 0.0f));
...
//    if (key_state = NULL) {
//        glm::vec3 decrease_accel =
//        glm::vec3 modified_acceleration = g_state.player->get_acceleration() -
//        g_state.player->set_acceleration(glm::vec3 new_acceleration)
//
//    }
    g_accumulator = delta_time;
}
